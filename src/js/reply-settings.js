...
(function () {
  ...
  const DEFAULTS = {
    ...
    // 群聊主动发送（成员主动来找你）——开关/概率/间隔/条数，存全局 gc-as-*
    'gc-as-en': 1, 'gc-as-prob': 25, 'gc-as-min': 20, 'gc-as-max': 60,
    'gc-as-count-min': 1, 'gc-as-count-max': 2
  };
  ...
  function syncUI() {
    ...
    // 开关
    ['py-en', 'as-en', 'as-badge', 'ml-kaomoji-en', 'ml-emoji-en', 'ml-sticker-en', 'cs-normal', 'cs-trigger-name', 'cs-trigger-bar', 'gc-py-en', 'gc-as-en', 'ckq-en', 'call-resume'].forEach(k => {
