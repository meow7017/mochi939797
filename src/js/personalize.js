...
// 组装菜单选项：背景操作 + （装修模式点卡片时）摆放操作
  ...
  // v3.x：桌面固定两页（第一页 + 音乐页），不再允许新增/删除页面
  const deskPageCount = () => 1;
  ...
  // v3.x：群聊强制开启——始终显示群聊图标，占卜入口也一直保留（不再随群聊开关折叠）
